...
--
-- Name: index_linked_accounts_on_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_linked_accounts_on_type ON public.linked_accounts USING btree (type);


--
-- Name: index_linked_accounts_on_type_and_account_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_linked_accounts_on_type_and_account_id ON public.linked_accounts USING btree (type, account_id);


--
-- Name: index_linked_accounts_on_type_and_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_linked_accounts_on_type_and_user_id ON public.linked_accounts USING btree (type, user_id);
